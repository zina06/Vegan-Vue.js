    ...
    <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab" tabindex="0"
      ...
      <div class="uform-container editform card" v-if="isEditing">
        <div class="inform card-body">
          <label style="text-align: left;"><b>식당 이름</b> </label><br> <input name="name" type="text"
            class="form-control restaurantname" v-model="restaurantName" required="required" /><br>
          <label style="float: left;"><b>메인 사진</b> </label><input class="form-control" type="file" multiple
            accept="image/*" ref="fileRef" name="file" @change="onChangeFile($event)"><br>
      ...
      <div class="uform-container card detailform" v-else>
        <div class="inform card-body">
          ...
          <img :src="require(`../../assets/img/restaurant/${images}`)" alt="이미지" class="uploadimg" @error="onImageLoad">
          <div>
...
export default {
  ...
  setup() {
    ...
    const getRestaurant = async () => {
      ...
      .catch((err)=>{
        images.value = "error.jpg"
        if(images.value=="error.jpg"){
          router.push({
            name : "Error"
          })
        }
    ...
    const onImageLoad = (e) => {
        console.log("에러라고씹루");
        e.target.src = '../../assets/img/restaurant/n_1.png';
        console.log("3123123");
        router.push({
          name: "Error"
      })
