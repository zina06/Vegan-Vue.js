<template>
    <head>
      ...
      <link src="@/assets/lib/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">
...
<!--     
                    ...
                    <div class="col-lg-7">
                        ...
                        <div class="border-top border-lg-0 my-2 mt-lg-0" >
                          ...
                          <form class="d-flex mt-4 mt-lg-0 ms-lg-auto ms-xl-0">
                            <div class="input-group-icon pe-2"><input class="form-control border-0 input-box bg-100" type="search" placeholder="Search Food" aria-label="Search" /></div>
                            <div class="input-group-icon pe-2"><span class="input-group-text"><i class="fas fa-search input-box-icon text-primary"></i></span></div>
                          </form>
                        </div>
                      

                      <h1 class="display-2 mb-5 animated slideInDown">Organic Food Is Good For Health</h1>
                      <router-link to="/product" class="btn btn-primary rounded-pill py-sm-3 px-sm-5">Products</router-link>
                      <router-link to="" class="btn btn-secondary rounded-pill py-sm-3 px-sm-5 ms-3">Services</router-link>
      ...
      <!-- <img class="w-100" src="@/assets/img/logo1.jpg" alt="Image">
      <div class="border-top border-lg-0 my-2 mt-lg-0" >
      ...
      <div class="container-fluid p-0 mb-5 wow fadeIn" data-wow-delay="0.1s">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img class="w-100" src="@/assets/img/2.jpg" alt="Image">
              <div class="carousel-caption">
                <div class="container">
                  <div class="row justify-content-start">
                    <div class="col-sm-7">
                        ...
                        <!-- <div class="border-top border-lg-0 my-2 mt-lg-0" >
                          <h1 class="display-2 mb-5 animated slideInDown">Organic Food Is Good For Health</h1>
                          <form class="d-flex mt-4 mt-lg-0 ms-lg-auto ms-xl-0">
                            <div class="input-group-icon pe-2"><input class="form-control border-0 input-box bg-100" type="search" placeholder="Search Food" aria-label="Search" style="width: 200px;"/></div>
                            <div class="input-group-icon pe-2"><span class="input-group-text"><i class="fas fa-search input-box-icon text-primary"></i></span></div>
                          </form>
                        </div> -->
                         ...
                         <div class="border-top border-lg-0 my-2 mt-lg-0" >
                          <h1 class="display-2 mb-5 animated slideInDown">Organic Food Is Good For Health</h1>
                          <!-- <form class="d-flex mt-4 mt-lg-0 ms-lg-auto ms-xl-0">
                            <div class="input-group-icon pe-2"><input class="form-control border-0 input-box bg-100" type="search" placeholder="Search Food" aria-label="Search" aria-describedby="basic-addon1"/></div>
                            <div class="input-group-icon pe-2"><span class="input-group-text"><i class="fas fa-search input-box-icon text-primary"></i></span></div>
                          </form> -->
                        </div> 
